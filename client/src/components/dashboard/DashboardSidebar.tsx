...
import { ActivityHeatmapItem, LeaderboardData, UserStats } from "@/lib/api";
...
export function DashboardSidebar({ practiceData, leaderboardData, userStats, loading }: DashboardSidebarProps) {
